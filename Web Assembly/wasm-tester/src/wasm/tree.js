...
var Module = (() => {
  ...
  return function (moduleArg = {}) {
    ...
    var _addPoints = (Module["_addPoints"] = createExportWrapper(
      "addPoints",
      2
    ));
    var _constructTree = (Module["_constructTree"] = createExportWrapper(
      "constructTree",
      0
    ));
    var _knn = (Module["_knn"] = createExportWrapper("knn", 2));
    var _printPoints = (Module["_printPoints"] = createExportWrapper(
      "printPoints",
      0
    ));
